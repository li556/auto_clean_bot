...
class InnoLidarClient : public InnoLidarBase {
 ...
 public:
  ...
  static const size_t kPacketPoolSize = 700;
 ...
 public:
  ...
  /**
  * @brief Get frame sync param
  * @param buf  // like "x=1,y=2,z=3,sync_time=421314145514,angleH=1111.034,angleV=2222.021";
  * @param buf_size // buf size
  * @return 0 for success, others for error
  */
  const int32_t get_frame_sync_param(char *buf, size_t buf_size);

  /**
  * @brief Set frame sync param
  * @param buffer  // like "x=1,y=2,z=3,sync_time=421314145514,angleH=1111.034,angleV=2222.021";
  * @return 0 for success, others for error
  */
  const int32_t set_frame_sync_param(const char *buffer);
 ...
 private:
  ...
  uint16_t port_;
  char *filename_;
  AngleHV anglehv_table_[kPolygonMaxFacets][kPolygonTableSize][kMaxSet][kMaxReceiverInSet];
