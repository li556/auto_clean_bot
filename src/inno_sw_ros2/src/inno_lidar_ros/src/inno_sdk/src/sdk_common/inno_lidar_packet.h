...
static const uint8_t kInnoMajorVersionDataPacket = 3;  // upgrade Major version from 2->3 2023/5/8
static const uint8_t kInnoMinorVersionDataPacket = 0;
static const uint16_t kInnoMagicNumberStatusPacket = 0x186B;
static const uint8_t kInnoMajorVersionStatusPacket = 3;  // upgrade Major version from 2->3 2023/5/8
...
enum InnoRecorderCallbackType {
  ...
  INNO_RECORDER_CALLBACK_TYPE_MAX = 8,
};
